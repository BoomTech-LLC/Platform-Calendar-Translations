let no = {
  ...
  "Next": "Neste",
   "Make your contribution by adding your event to the calendar" : "Gi ditt bidrag ved å legge til arrangementet ditt i kalenderen",
 "Event name" : "Arrangementsnavn",
 "Start time" : "Starttid",
 "End time" : "Sluttid",
 "Physical location" : "Fysisk beliggenhet",
 "Online" : "på nett",
 "To be announced" : "Å bli annonsert",
 "Add Image" : "Legg til bilde",
 "Event color" : "Hendelsesfarge",
 "Choose categories" : "Velg kategorier",
 "There are no categories to select" : "Det er ingen kategorier å velge",
 "Location name" : "Stedsnavn",
 "Location email" : "Plasserings -e -post",
 "Location phone" : "Plasseringstelefon",
 "Location website" : "Stedsnettsted",
