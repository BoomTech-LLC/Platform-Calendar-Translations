let cs = {
  ...
  "Description": "Popis",
  "Next": "Další",
   "Make your contribution by adding your event to the calendar" : "Přispějte přidáním vaší události do kalendáře",
 ...
 "Choose categories" : "Vyberte kategorie",
 "There are no categories to select" : "Neexistují žádné kategorie, které by si bylo možné vybrat",
 "Location name" : "Název umístění",
 "Location email" : "Poloha e -mail",
 "Location phone" : "Umístění telefon",
 "Location website" : "Webová stránka umístění",
 "Organizer name" : "Název organizátoru",
